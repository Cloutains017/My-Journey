...
grant select, insert, update, delete on public.admin_recycle_bin to service_role;
...
revoke all on function public.admin_login_attempt(text), public.admin_record_change(), public.admin_archive_delete(text,uuid), public.admin_restore(uuid), public.admin_purge_archive(uuid) from public, anon, authenticated;
grant execute on function public.admin_login_attempt(text), public.admin_record_change(), public.admin_archive_delete(text,uuid), public.admin_restore(uuid), public.admin_purge_archive(uuid) to service_role;
